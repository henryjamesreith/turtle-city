...
export function ChelseaApartment3D({ apartmentTier, hasSkateboard, onExitToChelsea, onPurchaseUpgrade, shells, turtleName, turtleVariant, upgrades }: { apartmentTier: number; hasSkateboard: boolean; onExitToChelsea: () => void; onPurchaseUpgrade: (itemKey: string) => Promise<void>; shells: number; turtleName: string; turtleVariant: TurtleVariant; upgrades: string[] }) {
  const [nearDoor, setNearDoor] = useState(false);
  const [upgradeError, setUpgradeError] = useState(""); const labels = ["Starter", "Freshened up", "Renovated", "Dream apartment"];
